function [ T1, T2, T3, T4, T5, T6, T7, direction_acc, direction_dec, deltP ] = updateDurations_Position_Setpoint( vel_sp, state_a, state_v, max_jerk, max_accel, max_velocity, p0, pt )
    ...
    delt_p_cruise = 0;
    [p_cruise, v_cruise, a_cruise, j_cruise] = updateTrajCruise( T4, T4, 0, v_acc, p_acc, 0, max_jerk );
